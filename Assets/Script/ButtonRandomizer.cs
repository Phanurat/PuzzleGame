...
public class ButtonRandomizer : MonoBehaviour
{
    ...
    public string correctSceneName = "Play_Level2"; // ชื่อฉากถัดไปหลังกดปุ่มถูก
    public string wrongSceneName = "";  // ชื่อฉากเดิมหลังกดปุ่มผิด (ถ้าไม่ต้องการเปลี่ยนหน้า ให้เว้นว่างไว้)
