...
public class RanromLevelSixPageOne : MonoBehaviour
{
    ...
    public string correctSceneName = "Play_Level6_Page2"; // ชื่อฉากถัดไปหลังกดปุ่มถูก
    public string wrongSceneName = "Play_Level6";  // ชื่อฉากเดิมหลังกดปุ่มผิด (ถ้าไม่ต้องการเปลี่ยนหน้า ให้เว้นว่างไว้)
