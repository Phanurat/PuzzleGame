...
public class RanromLevelFivePageFour : MonoBehaviour
{
    ...
    public string correctSceneName = "Play_Level5_Page5"; // ชื่อฉากถัดไปหลังกดปุ่มถูก
    public string wrongSceneName = "Play_Level5_Page3";  // ชื่อฉากเดิมหลังกดปุ่มผิด (ถ้าไม่ต้องการเปลี่ยนหน้า ให้เว้นว่างไว้)
